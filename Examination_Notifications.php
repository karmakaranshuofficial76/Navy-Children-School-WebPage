...
<html>
    ...
    <title>NCS | Examination Notification</title>
    <body>
        <div class="navbar">
        ...
        <br>
        <div class="main">
            <f2><text><marquee>Due To Coronavirus Pandemic Exams Are On Hold....The Same would be Notified To you later Via Principal.</marquee></text></f2>
        </div>
    </body>
</html>