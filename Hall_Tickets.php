...
<html>
    ...
    <body>
        ...
        <br>
        <div class="main">
            <f2><text><marquee>Due To Coronavirus Pandemic Exams Are On Hold....Hall Tickets Will Be Released Later After Coronavirus PANDEMIC ENDS AND Exams Reopens</marquee></text></f2>
        </div>
    </body>
</html>